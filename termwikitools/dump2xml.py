...
def keys2key_xml(concept_info, element_name, concept_xml):
    ...
    """
    if not (concept_info.get("sanctioned") and concept_info["sanctioned"] == "False"):
...
def contains_sami(concept_xml):
    uff = set.intersection(
        ...
        {lang.text for lang in concept_xml.xpath("./related_expression/language")},
    )
